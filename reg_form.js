...
//skills
let java = document.getElementById("male");
let cpp = document.getElementById("cpp");
let python = document.getElementById("other");
...
function submit() {
  ...
  BID = "BID" + date.getFullYear()+FormatDigit(date.getMonth())+FormatDigit(date.getDate())+FormatDigit(date.getHours())+FormatDigit(date.getMinutes())+FormatDigit(date.getSeconds())+FormatDigit(date.getMilliseconds());
    ...
    let li_skills = document.createElement("li");
...
function checkValidity() {
    if (studName == "" || email == "" || phone == "" || branch == "" || imgLink == "" || gender == "" || skills == "") {
...
if (content.trim()+"" == "") {
  container.innerHTML = '<div class="title">REGISTERED STUDENTS LIST</div>';
}
